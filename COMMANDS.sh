...
ECHO STATION AND TANK RELATIONSHIP (ONE TO MANY)
...
ECHO TANK AND FILL PIPE RELATIONSHIP (ONE TO ONE)
...
ECHO TANK AND PRODUCT PIPE RELATIONSHIP (ONE TO ONE)
...
az dt twin relationship create -n 'TtmDigitalTwins' --relationship-id 'rel_has_vent_pipe_02' --relationship 'rel_has_vent_pipe' -t 'Tank02' --target 'VentPipe02'
...
ECHO STATION AND DISPENSERS RELATIONSHIP (ONE TO MANY)
...
ECHO DISPENSERS AND TANKS RELATIONSHIP (MANY TO MANY)
...
ECHO DISPENSER TO PUMPS RELATIONSHIP (ONE TO MANY)
